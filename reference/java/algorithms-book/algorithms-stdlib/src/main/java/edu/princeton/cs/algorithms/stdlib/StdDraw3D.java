...
package edu.princeton.cs.algorithms.stdlib;
...
public final class StdDraw3D implements MouseListener, MouseMotionListener,
    ...
    private static JMenuBar createMenuBar() {
        ...
        SpinnerNumberModel snm = new SpinnerNumberModel(DEFAULT_FOV, 0.5, 3.0,
                0.05);
        ...
        SpinnerNumberModel snm2 = new SpinnerNumberModel(DEFAULT_NUM_DIVISIONS,
                4, 4000, 5);
    ...
    public static void setPenColor(Color col, int alpha) {
        setPenColor(new Color(col.getRed(), col.getGreen(), col.getBlue(),
                alpha));
    }
    ...
    private static void mouseMotionEvents(MouseEvent e, double newX,
            double newY, boolean dragged) {
        ...
        if ((cameraMode == AIRPLANE_MODE)) {
            if (dragged || immersive)
                camera.rotateRelative((mouseY - newY) / 4, (mouseX - newX) / 4,
                        0);
            return;
        }
    ...
    public static void addFog(Color col, double frontDistance,
            double backDistance) {
        LinearFog fog = new LinearFog(new Color3f(col), frontDistance,
                backDistance);
    ...
    public static Shape ellipsoid(double x, double y, double z, double w,
        ...
        sphere.setAppearance(createAppearance(imageURL, true));
        return primitive(sphere, x, y, z, new Vector3d(xA, yA, zA),
                new Vector3d(w, h, d));
    }
    ...
    public static Shape wireCube(double x, double y, double z, double r) {
        ...
        double[] zC = new double[] { z + r, z + r, z + r, z + r, z + r, z - r,
                z - r, z - r, z - r, z - r, z - r, z + r, z + r, z - r, z - r,
                z + r };
    ...
    public static Shape box(double x, double y, double z, double w, double h,
        ...
        com.sun.j3d.utils.geometry.Box box = new com.sun.j3d.utils.geometry.Box(
                dimensions.x, dimensions.y, dimensions.z, PRIMFLAGS, ap,
                numDivisions);
     ...
     */
    public static Shape wireBox(double x, double y, double z, double w,
            double h, double d) {
    ...
    public static Shape cone(double x, double y, double z, double r, double h,
        ...
        Appearance ap = createAppearance(imageURL, true);
        Vector3f dimensions = createVector3f(r, h, 0);
        Cone cone = new Cone(dimensions.x, dimensions.y, PRIMFLAGS,
                numDivisions, numDivisions, ap);
     ...
     * yA, zA).
     */
    private static Shape primitive(Primitive shape, double x, double y,
            double z, Vector3d angles, Vector3d scales) {
    ...
    public static Shape point(double x, double y, double z) {
        ...
        return points(new double[] { x }, new double[] { y },
                new double[] { z });
    }
    ...
    public static Shape lines(double[] x, double[] y, double[] z) {
        ...
        GeometryArray geom = new LineStripArray(coords.length,
                LineArray.COORDINATES, new int[] { coords.length });
        geom.setCoordinates(0, coords);
    ...
    private static Shape triangles(double[][] points, boolean filled) {
        ...
        for (int i = 0; i < size; i++) {
            coords[3 * i] = new Point3f(createVector3f(points[i][0],
        ...
        GeometryArray geom = new TriangleArray(size * 3,
    ...
    private static Shape triangles(double[][] points, Color[] colors,
        ...
        GeometryArray geom = new TriangleArray(size * 3,
                TriangleArray.COORDINATES | TriangleArray.COLOR_4);
        geom.setCoordinates(0, coords);
    ...
    public static void overlayPixel(double x, double y) {
        getGraphics2D(offscreenImage).fillRect((int) Math.round(scaleX(x)),
    ...
    public static void overlayPoint(double x, double y) {
        ...
        if (r <= 1)
            ...
            getGraphics2D(offscreenImage).fill(
                    new Ellipse2D.Double(scaleX(x) - r / 2, scaleY(y) - r / 2,
                            r, r));
    }
    ...
    public static void overlayLine(double x0, double y0, double x1, double y1) {
        getGraphics2D(offscreenImage).draw(
                new Line2D.Double(scaleX(x0), scaleY(y0), scaleX(x1),
                        scaleY(y1)));
    }
    ...
    private static void infoDisplay() {
        ...
        double d = b / 4;
        g.draw(new Line2D.Double(scaleX(d + center), scaleY(0 + center),
                scaleX(-d + center), scaleY(0 + center)));
    ...
    public static void saveScene3D(String filename) {
        ...
        try {
            SceneGraphFileWriter writer = new SceneGraphFileWriter(file,
                    universe, false, "3D scene saved from StdDraw3D.", null);
    ...
    public static void loadScene3D(String filename) {
        ...
        try {
            ...
            System.out.println("Branch graph count = "
                    + reader.getBranchGraphCount());
    ...
    public static class Light extends Transformable {
        ...
        private Light(BranchGroup bg, TransformGroup tg,
                javax.media.j3d.Light light) {
            super(tg);
            this.light = light;
            this.bg = bg;
